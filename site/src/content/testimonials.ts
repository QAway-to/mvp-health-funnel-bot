...
export const testimonials: readonly Testimonial[] = [
  ...
  //
  // СОГЛАСИЕ ЛЮДЕЙ НА ПУБЛИКАЦИЮ ПОЛУЧЕНО — заказчик подтвердил 03.09.2026.
  // Записано здесь, потому что вопрос «а можно ли это публиковать» возникает
  // у каждого, кто откроет файл и увидит настоящие имена на продающей
  // странице. Ответ: можно, спрошено и получено.
  //
