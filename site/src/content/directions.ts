 ...
 * добавлен под материал заказчика и с 28.08.2026 слит с самомассажем в одно
 * направление: приёмы там одни и те же, разница только в том, чьи руки.
 *
...
export const directions: readonly Direction[] = [
  ...
  {
    /**
     * Массаж и самомассаж были двумя направлениями до 28.08.2026. Слиты в
     * одно: приёмы у них буквально одни и те же, разница только в том, чьи
     * руки работают. Слаг оставлен прежним, `/samomassazh/` ведёт сюда
     * редиректом — ссылки на него уже разошлись.
     *
     * Глубина понижена до `materials` осознанно. Половина про выбор
     * специалиста разложена целиком, но в практической части автор ещё не дал
     * механику приёмов и технику массажа шеи. Пока их нет, «курс» был бы
     * обещанием того, чего человек не получит.
     */
    slug: 'massazh',
    title: 'Массаж и самомассаж',
    promise: 'Снимать напряжение своими руками — и знать, к кому идти, когда рук мало.',
    status: 'live',
    depth: 'materials',
    href: '/massazh/',
